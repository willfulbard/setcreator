class PageRender extends React.Component {
  ...
  render() {
    switch(this.props.page) {
      ...
      case 'tunelist':
        return (<TuneList tunes={this.props.tunes} selectedFigure={this.props.selectedFigure} selectedTunes={this.props.selectedTunes} loadingData={this.props.loadingData} />);
      default:
